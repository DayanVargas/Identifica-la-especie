...
const animales = [
    ...
    { nombre: 'Osteoglossum bichirrhosum', imagen: './img/OBichirrhosum.png' },
    { nombre: 'Anchoa lyolepis', imagen: './img/Al.png' },
    ...
    { nombre: 'Cetengraulis edetulus', imagen: './img/CEdentulus.png' },
    { nombre: 'Odontognathus mucronatus', imagen: './img/OMucronatus.png' },
    { nombre: 'Odontognathus compressus', imagen: './img/OCompresus.png' },
    ...
    { nombre: 'Sardinela autira', imagen: './img/SAurita.png' },
